...
{  
	$bookid = $_GET["bookid"];
	$id = $_GET["id"];
	$sql1 = "UPDATE booking SET `payment_status`='Paid' WHERE bookid=$bookid AND id=$id";
	$result1 = mysqli_query($conn, $sql1) or die(mysqli_connect_error($conn));
...
$dompdf = new Test();
$invoiceFileName = 'Invoice-'.$id.'.pdf';
