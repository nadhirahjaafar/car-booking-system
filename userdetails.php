...
echo "<div class='card shadow mb-4'>
            ...
            while($row = $result->fetch_assoc()){
                 ...
                 $driveric = $row ['driver ic no'];
                 $drivertel = $row ['driver phone no'];
                 $license = $row ['license'];
                 $start = $row ['license start period'];
                 $end = $row ['license end period'];
                 ...
                 <tr><td>Driver License</td><td>$license</td></tr>
            ...
            echo "</tbody></table>
             ...
             <a class='btn btn-primary' href='userlist.php?id=$id'> Back </a>
