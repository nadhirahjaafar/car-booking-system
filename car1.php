...
<html lang="en">
  <head>
    <title>Chrysler 300C Strechlimo</title>
    <meta charset="utf-8">
        ...
        <div class="col-md-12">
            <div id="custCarousel" class="carousel slide" data-ride="carousel" align="center">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active"> <img src="https://luxurylimo.my/wp-content/uploads/2019/08/Luxurylimo-limo-1.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/08/Luxurylimo-limo-2.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/08/Luxurylimo-limo-3.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/08/Luxurylimo-limo-4.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/08/Luxurylimo-limo-5.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/08/Luxurylimo-limo-6.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/08/Luxurylimo-limo-7.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/08/Luxurylimo-limo-10.jpg" alt="Hills"> </div>
...
<div class="text text-center">
    <br>
<span class="subheading">Limousine</span>
<h2><b>Chrysler 300C Strechlimo</b></h2>
</div>
</div>
</div>
</div>
...
<div class="col-md-4">
<ul class="features">
<li class="check"><span class="ion-ios-checkmark"></span>Leather Interior</li>
<li class="check"><span class="ion-ios-checkmark"></span>Bridal Door</li>
<li class="check"><span class="ion-ios-checkmark"></span>2x Air Con Systems</li>
<li class="check"><span class="ion-ios-checkmark"></span>Audio Visual Systems</li>

</ul>
</div>
<div class="col-md-4">
<ul class="features">
<li class="check"><span class="ion-ios-checkmark"></span>2x Rear Doors</li>
<li class="check"><span class="ion-ios-checkmark"></span>2WD</li>
<li class="check"><span class="ion-ios-checkmark"></span>4x Ice Buckets</li>
<li class="check"><span class="ion-ios-checkmark"></span>2x LCD Screen</li>

</ul>
</div>
<div class="col-md-4">
<ul class="features">
<li class="check"><span class="ion-ios-checkmark"></span>2x Bars</li>
<li class="check"><span class="ion-ios-checkmark"></span>5 Types of Lighting</li>
<li class="check"><span class="ion-ios-checkmark"></span>Roll Out Red Carpet</li>
<li class="check"><span class="ion-ios-checkmark"></span>20" RIMS</li>
...
<p>The Chrysler 300C enjoyed a wave of popularity, aided by celebrity owners (including US President Barack Obama) and appearances in music videos namely hip-hop music videos.</p>
<p>Fully imported 9.5 metres Chrysler 300C Stretch Limousine that can comfortably seat 12 persons. Arrive with rolled out red carpet with an ever ready chauffeur. Sit back on genuine leather seats and relax with a glass of champagne. Watch the city landscape roll by or view the world go by from the Chrysler 300C Stretch Limousine. Most importantly, make the journey that you will always remember or be remembered by.</p>
</div>
