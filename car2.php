        ...
        <div class="col-md-12">
            <div id="custCarousel" class="carousel slide" data-ride="carousel" align="center">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active"> <img src="https://luxurylimo.my/wp-content/uploads/2019/07/rr01.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/07/rr02.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/07/rr03.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/07/rr04.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/07/rr05.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/07/rr06.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/07/rr07.jpg" alt="Hills"> </div>
                    <div class="carousel-item"> <img src="https://luxurylimo.my/wp-content/uploads/2019/07/rr08.jpg" alt="Hills"> </div>
...
<div class="col-md-4">
<ul class="features">
<li class="check"><span class="ion-ios-checkmark"></span>6.6 Litre Engine</li>
<li class="check"><span class="ion-ios-checkmark"></span>Air Conditioning</li>
<li class="check"><span class="ion-ios-checkmark"></span>Natural Grain Leather</li>
<li class="check"><span class="ion-ios-checkmark"></span>4 Doors</li>
...
<div class="col-md-4">
<ul class="features">
<li class="check"><span class="ion-ios-checkmark"></span>Tea Trays for Passengers</li>
<li class="check"><span class="ion-ios-checkmark"></span>2x TV Screens for Passengers</li>
<li class="check"><span class="ion-ios-checkmark"></span>Mineral Water</li>
<li class="check"><span class="ion-ios-checkmark"></span>Wet Towels</li>
...
<p>The Rolls-Royce Ghost is a British luxury car manufactured by Rolls-Royce Motor Cars. The “Ghost” nameplate was named in honour of the Rolls Royce Silver Ghost, which was first produced in 1906 and the origin of Rolls-Royce’s claim of making the “best car in the world”. The Rolls-Royce Ghost engine allows it to accelerate from 0 to 60 mph (97 km/h) in 4.7 seconds.</p>
<p>Our Rolls-Royce Ghost is maintained to perfection to ensure an unforgettable experience.</p>
</div>
